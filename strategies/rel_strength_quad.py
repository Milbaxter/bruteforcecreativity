"""
Relative Strength Quad — 4-asset SPY relative strength rotation.

Expand the validated SPY Rel Strength Alpha framework to 4 assets:
SLV (silver), XLF (banks), SOXX (semis), GDX (gold miners).

4 assets instead of 3 means: higher probability of having at least one SPY
outperformer at any time, reducing time in cash.
"""
...
STRATEGY = {
    "name": "Rel Strength Quad",
    "hypothesis": "4-asset relative strength: SLV/XLF/SOXX/GDX vs SPY. More candidates = more time invested in outperformers.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Four-way relative strength across commodity (SLV), banking (XLF), growth (SOXX), and gold mining (GDX) sectors.",
}
