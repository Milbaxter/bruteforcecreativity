"""
International Relative Strength — EWJ/INDA/SLV/SOXX vs SPY rotation.

Two hot international markets (Japan, India) + commodity (SLV) + tech (SOXX).
Japan and India have been outperforming many developed markets and are driven by
different catalysts (Japan: BOJ policy + corporate reform, India: demographic growth).
"""

import pandas as pd
import numpy as np

ASSETS = ["EWJ", "INDA", "SLV", "SOXX"]

STRATEGY = {
    "name": "Intl Rel Strength",
    "hypothesis": "EWJ/INDA/SLV/SOXX relative strength vs SPY. International + commodity + tech for maximum diversification.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "International markets (Japan, India) as relative strength candidates alongside commodity and tech. Cross-border diversification.",
}
