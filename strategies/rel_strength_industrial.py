"""Rel Strength Industrial — SLV/XLI/SOXX/GDX relative strength vs SPY."""

import pandas as pd
import numpy as np

ASSETS = ["SLV", "XLI", "SOXX", "GDX"]

STRATEGY = {
    "name": "Rel Strength Industrial",
    "hypothesis": "SLV/XLI/SOXX/GDX relative strength vs SPY. Industrials as manufacturing cycle alpha.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Industrials (XLI) as fourth asset — manufacturing and infrastructure cycle.",
}
