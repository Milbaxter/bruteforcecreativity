"""
Relative Strength Five — 5-asset SPY relative strength rotation.

SLV + XLF + SOXX + GDX + XLE. Five diverse sectors. Maximum diversification of
relative strength candidates. Energy (XLE) adds an inflation-sensitive component.
"""

import pandas as pd
import numpy as np

ASSETS = ["SLV", "XLF", "SOXX", "GDX", "XLE"]

STRATEGY = {
    "name": "Rel Strength Five",
    "hypothesis": "5-asset relative strength: SLV/XLF/SOXX/GDX/XLE vs SPY. Five sectors for maximum candidate diversity.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Five-way relative strength across silver, banks, semis, gold miners, and energy.",
}
