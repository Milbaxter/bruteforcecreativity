"""
Relative Strength Healthcare — SLV/XLV/SOXX/GDX relative strength vs SPY.

Healthcare (XLV) instead of XLF. XLV is driven by: FDA approvals, aging demographics,
drug pricing policy, healthcare spending. Completely independent of interest rates
(unlike XLF), making it a genuinely different diversifier.
"""

import pandas as pd
import numpy as np

ASSETS = ["SLV", "XLV", "SOXX", "GDX"]

STRATEGY = {
    "name": "Rel Strength Health",
    "hypothesis": "SLV/XLV/SOXX/GDX relative strength vs SPY. Healthcare (XLV) as defensive pillar independent of rates.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Healthcare (not banks) as defensive component. FDA/demographic catalysts are independent of macro cycle.",
}
