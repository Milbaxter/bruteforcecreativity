"""
Relative Strength REIT — SLV/XLRE/SOXX/GDX relative strength vs SPY.

Real estate (XLRE): interest rate sensitive + inflation hedge + demographic demand.
"""

import pandas as pd
import numpy as np

ASSETS = ["SLV", "XLRE", "SOXX", "GDX"]

STRATEGY = {
    "name": "Rel Strength REIT",
    "hypothesis": "SLV/XLRE/SOXX/GDX relative strength vs SPY. Real estate as rate-sensitive defensive.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Real estate (XLRE) as fourth asset — rate-sensitive, inflation-hedging real asset.",
}
