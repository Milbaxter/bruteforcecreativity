"""
Relative Strength Defense Trio — XAR/SLV/XLF relative strength vs SPY.

Defense (XAR) is driven by government spending, geopolitics, and bipartisan support.
It provides alpha independent of the economic cycle. Combined with SLV (commodity)
and XLF (banks), three uncorrelated alpha sources.
"""
...
STRATEGY = {
    "name": "Rel Strength Defense",
    "hypothesis": "XAR/SLV/XLF relative strength vs SPY. Defense spending + commodity + bank cycle. Three uncorrelated alpha sources.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Defense ETF (XAR) as primary growth asset — government spending immune to economic cycles.",
}
