"""
Relative Strength Staples — SLV/XLP/SOXX/GDX relative strength vs SPY.

Consumer staples (XLP): Procter & Gamble, Coca-Cola, Walmart, Costco. Most defensive
equity sector. Revenue is recession-proof (people always buy groceries). XLP tends to
outperform SPY during risk-off periods, providing a different alpha source than
commodity (SLV/GDX) or growth (SOXX).
"""

import pandas as pd
import numpy as np

ASSETS = ["SLV", "XLP", "SOXX", "GDX"]

STRATEGY = {
    "name": "Rel Strength Staples",
    "hypothesis": "SLV/XLP/SOXX/GDX relative strength vs SPY. Consumer staples as defensive pillar.",
    "universe": ASSETS + ["SPY"],
    ...
    "eccentricity": "Consumer staples (XLP) as the defensive equity slot. Recession-proof revenue base.",
}
